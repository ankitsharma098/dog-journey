...
- `Dog Journey Royal Redesign.html` — the standalone, offline, **interactive** prototype. Open it in a browser; the chips under the first phone jump between all 12 screens. Start here.
